...
const remoteFingerprintCache = new Map<string, Promise<VisualFingerprint | null>>();
...
function normalizeCrop(crop?: Partial<NormalizedCrop> | null): NormalizedCrop | null {
  if (!crop) return null;
